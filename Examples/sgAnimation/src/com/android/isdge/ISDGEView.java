 ...
 */
class ISDGEView extends GLSurfaceView {
    private static String TAG = "ISDGEView";
    private static final boolean DEBUG = false;

    public ISDGEView(Context context) {
        super(context);
        init(false, 0, 0);
    }

    public ISDGEView(Context context, boolean translucent, int depth, int stencil) {
        super(context);
